...
per-row column summed to **€674,18 of tax** while the real position for the year was a **net
loss of €170,85** — nothing owed, and €170,85 carried forward against future gains. Acting on
...
def tax_on_next_gain(sales: list, year: str, gain: float) -> dict:
    ...
    loss already banked: with €3.188 of realised losses sitting in the pot, a €2.000 gain
    adds nothing, and quoting €527 of tax against it is an argument not to sell that is
    simply untrue."""
