...
a day the portfolio actually rose 1,41%, because €4.016 of new cash arrived and bought DELL.
...
were same-day rotations — MU sold for €3.999 and FIX bought for €4.010 on 11.08 — where the
...
def total_return_pct(points: list, holdings: list, sales: list) -> Optional[float]:
    ...
    (last - first) / first, which counts every deposit as a gain — on a €91.256 portfolio
    holding €4.016 of cash that arrived today, that is not a rounding error."""
